...
@Slf4j
public class Springs implements ApplicationContextAware, DisposableBean {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) {
        ...
        if (Springs.applicationContext != null) {
            log.warn("SpringContextHolder中的ApplicationContext被覆盖, 原有ApplicationContext为:" + Springs.applicationContext);
        }
